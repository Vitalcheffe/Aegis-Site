...
export default function AegisSentinelPage() {
  return (
    <>
      <ProductHero
        image="/images/pages/aegis-sentinel-hero.jpg"
      ...
      <SplitSection
        image="/images/pages/sentinel-ai-neural.jpg"
      ...
      <SplitSection
        image="/images/pages/sentinel-tower.jpg"
      ...
      <SplitSection
        image="/images/pages/sentinel-watch.jpg"
      ...
      <ImageBreak image="/images/pages/sentinel-watch.jpg" height="50vh" />
      ...
      <SpecTable
        ...
        title="Aegis Sentinel Specifications"
        specs={[
          { category: "Performance" },
          { label: "Detection Range (Radar)", value: "10 km (small UAS Class I)" },
          { label: "Detection Range (RF)", value: "15 km (command link)" },
          { label: "Tracking Capacity", value: "150+ concurrent targets" },
          { label: "Classification Accuracy", value: "99.1% (multi-modal fusion)" },
          { label: "Kill Chain Closure", value: "<15 seconds (detect-to-neutralize)" },
          { label: "Classification Latency", value: "<25 ms" },
          { label: "Update Rate", value: "30 Hz" },
          { label: "Coverage", value: "360° azimuth, -5° to +80° elevation" },
          { category: "Sensors" },
          { label: "AI Processing", value: "120 TOPS" },
          { label: "AI Architecture", value: "3-layer neural (classify-assess-decide)" },
          { label: "Radar Band", value: "Ku-band" },
          ...
          { label: "Weight", value: "2,800 kg (system total)" },
          { label: "Mounting Options", value: "Fixed tower, perimeter, vehicle-mounted" },
          ...
          { label: "Network Interfaces", value: "STANAG 4586, encrypted tactical data link" },
          { label: "Interoperability", value: "JADC2, Aegis Command, coalition networks" },
          { label: "Remote Management", value: "Encrypted OTA updates, remote ROE config" },
