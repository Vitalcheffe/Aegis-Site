  ...
  return (
    <>
      ...
      <SpecTable
        ...
        title="Aegis Tactical Specifications"
        specs={[
          { category: "Performance" },
          { label: "Detection Range (Radar)", value: "18 km" },
          { label: "Detection Range (RF)", value: "25 km" },
          { label: "Tracking Capacity", value: "200+ concurrent targets" },
          { label: "Classification Accuracy", value: "98.7%" },
          { label: "Kill Chain Closure", value: "<35 ms" },
          { label: "Update Rate", value: "25 Hz" },
          { label: "Min RCS Detection", value: "0.001 m²" },
          { label: "Engagement Time", value: "<5 seconds (detect-to-neutralize)" },
          { label: "Coverage", value: "360° azimuth, -5° to +80° elevation" },
          { category: "Sensors" },
          { label: "AI Processing", value: "85 TOPS" },
          { label: "Radar Bands", value: "X-band" },
          ...
          { label: "Jamming Output", value: "50W per band (6 concurrent bands)" },
          { category: "Physical" },
          { label: "Power Consumption", value: "1.8 kW (typical), 2.5 kW (peak)" },
          { label: "Weight", value: "3,400 kg (system total)" },
          { label: "Form Factor", value: "Vehicle-integrated, single-platform" },
          { label: "Deployment Time", value: "30 minutes (full operational)" },
          { label: "Redeployment Time", value: "20 minutes" },
          { label: "Airlift Compatibility", value: "C-130, CH-47, standard flatbed" },
          { label: "Onboard Endurance", value: "72 hours (single fuel load)" },
          ...
          { label: "Network Interfaces", value: "STANAG 4586, tactical radio, SATCOM" },
          { label: "Interoperability", value: "JADC2, Link 16, NATO C2" },
